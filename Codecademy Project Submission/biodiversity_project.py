...
scientific_name = [4,10,16,161,5633]
conservation_status = ["In Recovery","Threatened","Endangered","Species of Concern","No Intervention"]
...
contains_sheep = lambda word : True if "Sheep" in word else False
species["is_sheep"] = species.common_names.apply(contains_sheep)
print species.head()
...
observations = [250,149,507,282]
plt.figure(figsize=(16,4))
ax = plt.subplot()
plt.bar(range(len(park_name)),observations)
ax.set_xticks(range(len(park_name)))
ax.set_xticklabels(park_name)
...
minimum_detectable_effect = 5.0/15.0 *100
...
No_of_weeks_bryce_park = sample_size_per_park / 250.0
print(No_of_weeks_bryce_park)


# In[115]:


No_of_weeks_yellowstone_park = sample_size_per_park / 507.0
print(No_of_weeks_yellowstone_park)
